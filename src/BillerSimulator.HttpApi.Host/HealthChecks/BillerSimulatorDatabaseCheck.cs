...
public class BillerSimulatorDatabaseCheck : IHealthCheck, ITransientDependency
{
    protected readonly IIdentityRoleRepository IdentityRoleRepository;

    public BillerSimulatorDatabaseCheck(IIdentityRoleRepository identityRoleRepository)
    {
